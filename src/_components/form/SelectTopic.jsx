  ...
  return (
    <div className="relative md:max-w-xs" ref={dropdown}>
      <div
        ...
        ${
          isShow &&
          ' bg-green-400 border-t border-r border-l rounded-tl-lg rounded-tr-lg shadow-xl'
        }`}
      ...
      {isShow && (
        ...
        >
          <div
            className="forum_frameIcon__2fNr2 overflow-scroll"
